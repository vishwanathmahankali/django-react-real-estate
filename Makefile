...
Windows doesn't have a built-in make command like Unix-based systems. 
However, you can easily simulate Makefile behavior in Windows using batch scripts.

Created a file named run_commands.bat

Use command `run_commands.bat`, and you'll be presented with a menu to choose the action you want to perform.