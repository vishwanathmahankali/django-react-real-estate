...
class Property(TimeStampedUUIDModel):
    ...
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Kolkata")
    postal_code = models.CharField(
        verbose_name=_("Postal Code"), max_length=100, default="654321"
    )
    street_address = models.CharField(
        verbose_name=_("Street Address"), max_length=150, default="KK8 Avenue"
    )
